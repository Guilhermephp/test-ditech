...
/**
 * Login.class[ MODEL ]
 * Classe responsável por autenticar, validar e checar usuário do sistema de login.
...
class Login {
    ...
    /**
     * <b>Informar Level:</b> Informe o níel de acesso mánimo para a área a ser protegida.
     * @param INT $Level = Nível máximo para acesso
     */
